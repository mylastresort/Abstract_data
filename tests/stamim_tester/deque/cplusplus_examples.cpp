...
void cplusplusexamples_deque()
{
...

  {
    ...
    for (deque<int>::const_iterator it = second.begin(); it != second.end(); it++)
    {
      cout << *it << endl;
    }
    ...
    for (deque<int>::const_iterator it = third.begin(); it != third.end(); it++)
    {
      cout << *it << endl;
    }
    ...
    for (deque<int>::const_iterator it = fourth.begin(); it != fourth.end(); it++)
    {
      cout << *it << endl;
    }
