...
{
	// NOLINTNEXTLINE
	return deque_iterator< U >((typename deque_iterator< U >::data_t)data,
							   current);
}
...
template < class T >
bool deque_iterator< T >::operator!=(const deque_iterator& rhs)
{
...
template < class T >
const typename deque_iterator< T >::reference
deque_iterator< T >::operator[](int pos) const
{
